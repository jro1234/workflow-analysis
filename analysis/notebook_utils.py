...
# no xwindows #from IPython.core.display import display, HTML

pd.set_option('expand_frame_repr', False)
# no xwindows #pd.set_option('display.max_rows', 50)
...
# no xwindows ##Expand the notebook to the width of the browser
# no xwindows #display(HTML("<style>.container { width:100% !important; }</style>"))
